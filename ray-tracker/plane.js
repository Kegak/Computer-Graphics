...
class Plane{
    ...
    intersect(rayOrigin, rayDirection){
        ...
        //Calculate the collision locatiom
        //The location is orgin + direction scaled by time to collision
        //let collisionLocation = rayOrigin.add(rayDirection.scale(timeToCollision));

        //Return all the details about the collision
        //Return the time to collision, collision location, and normal at collision (ABC)
