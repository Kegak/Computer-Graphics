/**
 * A triangle class, with vettices specified in counter-clockwise order
 */
class Triangle{
    /**
     * 
     * @param {Vector3} one The first index
     * @param {Vector3} two The second index
     * @param {Vector3} three The thrid index
     */
